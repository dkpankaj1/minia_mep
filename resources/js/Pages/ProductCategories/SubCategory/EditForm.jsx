...
const EditForm = ({ editedData, categories }) => {
        ...
        <Modal toggler={editModelToggler} isOpen={showAddModel}>
          ...
          <ModalBody>
            ...
            <div className="mb-3">
              ...
              <FormSelect value={data.category} onChange={e => setData('category', e.target.value)}>
            ...
            <div className="mb-3">
              ...
              <FormInput type="text" className="form-control" placeholder="Enter SubCategory Name"
