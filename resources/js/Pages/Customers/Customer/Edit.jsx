...
function Edit({ customer, customerGroup }) {
    ...
    <AuthLayout>
      ...
      <Card>
        <CardHeader>
          ...
          <p className='card-title-desc'>Modify the details of the Customer. Ensure all fields are correctly filled out before saving changes.</p>
        </CardHeader>
